...
/*-------------------------------- initialization ---------------------------*/
 ...
 pkeystruct key[] =
 {
  ...
  {"BACK_TYPE", P_KEYLIST, prefs.back_type, 0,0, 0.0,0.0,
   {"AUTO", "MANUAL", ""}, 1, MAXIMAGE, &prefs.nback_type},
...
#endif
   "DEBLEND_MODELS", "-DEBLEND_MODELS", "OTHER", ""},
  ...
  {"DEBLEND_FITTOL", P_FLOAT, &prefs.deblend_fittol, 0,0, 0.0, BIG},
  ...
  {"DETECT_THRESH", P_FLOATLIST, prefs.dthresh, 0,0, -BIG, BIG,
   {""}, 1, 2, &prefs.ndthresh},
  {"DETECT_TYPE", P_KEYLIST, prefs.detector_type, 0,0, 0.0,0.0,
   {"CCD","PHOTO",""}, 1, MAXIMAGE, &prefs.ndetector_type},
  ...
  {"FITS_UNSIGNED", P_BOOLLIST, prefs.fitsunsigned_flag, 0,0, 0.0,0.0,
   {""}, 1, MAXIMAGE, &prefs.nfitsunsigned_flag},
  {"FLAG_IMAGE", P_STRINGLIST, prefs.fimage_name, 0,0,0.0,0.0,
    {""}, 0, MAXFLAG, &prefs.nfimage},
  {"FLAG_TYPE",  P_KEYLIST, prefs.flag_type, 0,0, 0.0,0.0,
   {"OR","AND","MIN", "MAX", "MOST",""}, 0, MAXFLAG, &prefs.nflag_type},
  {"GAIN", P_FLOATLIST, prefs.gain, 0,0, 0.0, 1e+30,
   {""}, 1, MAXIMAGE, &prefs.ngain},
  ...
  {"INTERP_MAXXLAG", P_INTLIST, prefs.interp_xtimeout, 1,1000000, 0.0,0.0,
   {""}, 1, MAXIMAGE, &prefs.ninterp_xtimeout},
  {"INTERP_MAXYLAG", P_INTLIST, prefs.interp_ytimeout, 1,1000000, 0.0,0.0,
   {""}, 1, MAXIMAGE, &prefs.ninterp_ytimeout},
  {"INTERP_TYPE", P_KEYLIST, prefs.interp_type, 0,0, 0.0,0.0,
   {"NONE","VAR_ONLY","ALL",""}, 1, MAXIMAGE, &prefs.ninterp_type},
  {"MAG_GAMMA", P_FLOATLIST, prefs.mag_gamma, 0,0, 1e-10,1e+30,
   {""}, 1, MAXIMAGE, &prefs.nmag_gamma},
  {"MAG_ZEROPOINT", P_FLOATLIST, prefs.mag_zeropoint, 0,0, -100.0, 100.0,
   {""}, 1, MAXIMAGE, &prefs.nmag_zeropoint},
  ...
  {"PHOTSHARING_TYPE", P_KEY, &prefs.photsharing_type, 0,0, 0.0,0.0,
   {"ALL","ALL-DETECT","DETECT","NONE",""}},
  {"PIXEL_SCALE", P_FLOATLIST, prefs.pixel_scale, 0,0, 0.0, 1e+10,
   {""}, 1, MAXIMAGE, &prefs.npixel_scale},
  ...
  {"RESCALE_WEIGHTS", P_BOOLLIST, prefs.wscale_flag, 0,0, 0.0,0.0,
   {""}, 1, MAXIMAGE, &prefs.nwscale_flag},
  {"SATUR_KEY", P_STRING, prefs.satur_key},
  {"SATUR_LEVEL", P_FLOATLIST, prefs.satur_level, 0,0, -1e+30, 1e+30,
   {""}, 1, MAXIMAGE, &prefs.nsatur_level},
  {"SEEING_FWHM", P_FLOATLIST, prefs.seeing_fwhm, 0,0, 0.0, 1e+10,
   {""}, 1, MAXIMAGE, &prefs.nseeing_fwhm},
  {"SOM_NAME", P_STRING, prefs.som_name},
  {"STARNNW_NAME", P_STRING, prefs.nnw_name},
  {"THRESH_TYPE", P_KEYLIST, prefs.thresh_type, 0,0, 0.0,0.0,
   {"RELATIVE","ABSOLUTE"}, 1, 2, &prefs.nthresh_type},
  {"VERBOSE_TYPE", P_KEY, &prefs.verbose_type, 0,0, 0.0,0.0,
   {"QUIET","NORMAL", "EXTRA_WARNINGS", "FULL",""}},
  {"WEIGHT_GAIN", P_BOOLLIST, prefs.weightgain_flag, 0,0, 0.0,0.0,
   {""}, 1, MAXIMAGE, &prefs.nweightgain_flag},
  {"WEIGHT_IMAGE", P_STRINGLIST, prefs.wimage_name, 0,0,0.0,0.0,
    {""}, 0, MAXIMAGE, &prefs.nwimage},
...
"WEIGHT_IMAGE                    # weight-map filename",
...
"#------------------------------ Photometry -----------------------------------",
" ",
"PHOTSHARING_TYPE ALL            # how data are shared across channels",
